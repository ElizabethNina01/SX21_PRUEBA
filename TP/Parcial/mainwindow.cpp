    ...
    , ui(new Ui::MainWindow)
{
    ...
    QPixmap logoper(":/EXTRAS/EXTRAS/mis amigos.png");
    ui->lblAmigos->setPixmap(logoper.scaled(300,300,Qt::KeepAspectRatio));
...
void MainWindow::ColaDeFakes(){
   ...
   for(int i=1;i<=50;i++){
      ...
      Persona<string,int>*new_fake = new Persona<string,int>(nombre, trabajo, hobby,estado ,edad,numero, photo);
       fakes->push(new_fake);
   }
}
